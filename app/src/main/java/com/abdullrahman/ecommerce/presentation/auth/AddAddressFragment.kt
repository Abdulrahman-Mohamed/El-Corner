...
class AddAddressFragment : Fragment() {
    ...
    private lateinit var dataBinding: FragmentAddAddressBinding
    private var userLocationAcurracyCircle: Circle? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       viewModel.isSignedUp.observe(requireActivity(), Observer {
           if (it)
           {
               nav.navigate(R.id.action_addAddressFragment_to_signInFragment)
           }
       })
